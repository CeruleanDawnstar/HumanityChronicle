 ...
 */
final class Version20200813145456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE personnalites (id INT AUTO_INCREMENT NOT NULL, invention_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_naissance SMALLINT NOT NULL, date_deces SMALLINT DEFAULT NULL, biographie LONGTEXT NOT NULL, img_url VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_411DF31D8A097851 (invention_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
